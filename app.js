...
app.use(favicon(path.join(__dirname, 'public','images', '01.jpg')));
app.use(logger('dev'));
...
// redis多个值的设置与获取
// redisClient.on('connect',function () {
//   redisClient.hmset('short',{'js':'javascript','C#':'C sharp'});
//   redisClient.hmset('short','SQL','Structured Query Language','HTML','HyperText Mark-up Language');
//
